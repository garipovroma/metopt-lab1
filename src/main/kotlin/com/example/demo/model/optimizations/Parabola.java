...
public class Parabola {
    private static class Four<T> {
        private T first, second, third, fouth;

        public Four(T first, T second, T third, T fouth) {
            this.first = first;
            this.second = second;
            this.third = third;
            this.fouth = fouth;
        ...
        public void setFouth(T fouth) {
            this.fouth = fouth;
        }
    }
    private static class Three<T> {
